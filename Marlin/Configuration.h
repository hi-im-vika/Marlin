...
#define STRING_CONFIG_H_AUTHOR "vika (me@vika.ws)" // Who made the changes.
...
#define PID_K1 0.95       // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  21.51     // ATTN: Values taken from autocalibration on TFT35
 ...
 */
#define PIDTEMPBED  // ATTN: pidtempbed enabled
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp  56.70
  #define DEFAULT_bedKi  10.80
  #define DEFAULT_bedKd 198.51
...
#define EXTRUDE_MAXLENGTH 600 // CHANGED: 200 -> 600
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 100 }    // ATTN: Changed from 500 to 100
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 20, 120 } // REVIEW: increased from { 300, 300, 5, 25 }
// REVIEW: may cause terrible clicking noise from esteps
...
// ATTN: may affect sound of printer, orig. values are all 3000
...
#define CLASSIC_JERK
  ...
  #define DEFAULT_ZJERK  0.4 // ATTN: set from M205 of printer
 ...
 *     O-- FRONT --+
 */
// REVIEW: figure out the proper nozzle to probe offset
// REVIEW: how bout you review deez nuts

#define NOZZLE_TO_PROBE_OFFSET { -40, -10, -1.680 }
...
// ATTN: change in hopes of making the y homing not click anymore
#define PROBING_MARGIN 20

// X and Y axis travel speed (mm/min) between probes
#define XY_PROBE_FEEDRATE (150*60) // CHANGED: 133 -> 150

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (20*60) // CHANGED: 4 -> 20
...
#define Z_CLEARANCE_BETWEEN_PROBES  3 // Z Clearance between probe points // CHANGED: 5 -> 3
...
#define Z_MAX_POS 350 // CHANGED: you installed a height upgrade from 250 mm to 350 mm !
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
 ...
 */
#define FILAMENT_RUNOUT_SENSOR // ATTN: congrats on finally getting a SFS and deez nuts !

#if ENABLED(FILAMENT_RUNOUT_SENSOR)
  #define FIL_RUNOUT_ENABLED_DEFAULT true // Enable the sensor on startup. Override with M412 followed by M500.
  #define NUM_RUNOUT_SENSORS   1          // Number of sensors, up to one per extruder. Define a FIL_RUNOUT#_PIN for each.

  #define FIL_RUNOUT_STATE     LOW        // Pin state indicating that filament is NOT present. // CHANGED: may or may not work, changed to high from low
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_HEIGHT      0.2        // (mm) Z height of nozzle at leveling points // ATTN: thickness of levelling gauge, i chose 0.2 mm, two sheets of paper or folded
...
// CHANGED: might affect how fast it homes
// #define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (4*60) }
// #define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (4*60) } // CHANGED: different from before, faster than { (20*60), (20*60), (4*60) }
#define HOMING_FEEDRATE_MM_M { (150*60), (150*60), (10*60) } // ATTN: 2023 update: SPEED
