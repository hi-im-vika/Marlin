...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_PIN PC7           // Set a custom pin for the controller fan // REVIEW: may or may not work
...
// @section bltouch
  ...
  #define BLTOUCH_DELAY 300   // CHANGED: on suggestion from yt video 500 -> 300
   ...
   */
  // #define BLTOUCH_SET_5V_MODE // ATTN: remains off, turn on if can work
...
#define LIN_ADVANCE
    ...
    #define ADVANCE_K { 0.45 }    // (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
 ...
 */
#define HOST_ACTION_COMMANDS  // CHANGED: this can help with M600 stall
